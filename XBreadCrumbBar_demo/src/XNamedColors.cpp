...
{
	_ASSERTE((nSysColorIndex >= 0) && (nSysColorIndex <= COLOR_GRADIENTINACTIVECAPTION));

	if ((nSysColorIndex >= 0) && (nSysColorIndex <= COLOR_GRADIENTINACTIVECAPTION))
